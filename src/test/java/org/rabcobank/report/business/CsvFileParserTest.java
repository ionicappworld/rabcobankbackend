...
public class CsvFileParserTest {
	...
	public void writeValidtedReportCsvFail() {
		...
		List<CustomerStatements> stataments = new ArrayList<CustomerStatements>();
		CustomerStatements cs1 = new CustomerStatements(1234,"testing1","testing2",new BigDecimal(11),new BigDecimal(23),new BigDecimal(22));
		CustomerStatements cs21 = new CustomerStatements(1234,"testing2","testing3",new BigDecimal(3),new BigDecimal(-1),new BigDecimal(6));
		stataments.add(cs1);
		stataments.add(cs21);
		...
		try {
			...
			for (CustomerStatements stats : stataments) {
				...
				System.out.println("Sum of balance : " +(stats.getStart_Balance().add(stats.getMutation())));
				System.out.println("Total : " +(stats.getStart_Balance().add(stats.getMutation())).compareTo(stats.getEnd_Balance()));
				assertFalse(stats.getStart_Balance().add(stats.getMutation()).compareTo(stats.getEnd_Balance())== 0);
